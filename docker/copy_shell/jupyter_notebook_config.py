...
#------------------------------------------------------------------------------
## Set the Access-Control-Allow-Credentials: true header
#  See also: NotebookApp.allow_credentials
# c.LabApp.allow_credentials = False

## Set the Access-Control-Allow-Origin header
#  See also: NotebookApp.allow_origin
# c.LabApp.allow_origin = ''

## Use a regular expression for the Access-Control-Allow-Origin header
#  See also: NotebookApp.allow_origin_pat
# c.LabApp.allow_origin_pat = ''

## Allow password to be changed at login for the notebook server.
#  See also: NotebookApp.allow_password_change
# c.LabApp.allow_password_change = True

## Allow requests where the Host header doesn't point to a local server
#  See also: NotebookApp.allow_remote_access
# c.LabApp.allow_remote_access = False
...
#  Default: '/opt/conda/envs/daseIntro/share/jupyter/lab'
# c.LabApp.app_dir = '/opt/conda/envs/daseIntro/share/jupyter/lab'
...
# c.LabApp.base_project_url = '/'

## The base URL for the notebook server.
#  See also: NotebookApp.base_url
# c.LabApp.base_url = '/'

## Specify what command to use to invoke a web
#  See also: NotebookApp.browser
# c.LabApp.browser = ''

## The full path to an SSL/TLS certificate file.
#  See also: NotebookApp.certfile
# c.LabApp.certfile = ''

## The full path to a certificate authority certificate for SSL/TLS client
#  authentication.
#  See also: NotebookApp.client_ca
# c.LabApp.client_ca = ''
...
## The config manager class to use
#  See also: NotebookApp.config_manager_class
# c.LabApp.config_manager_class = 'notebook.services.config.manager.ConfigManager'

## The notebook manager class to use.
#  See also: NotebookApp.contents_manager_class
# c.LabApp.contents_manager_class = 'notebook.services.contents.largefilemanager.LargeFileManager'

## Extra keyword arguments to pass to `set_secure_cookie`. See tornado's
#  set_secure_cookie docs for details.
#  See also: NotebookApp.cookie_options
# c.LabApp.cookie_options = {}

## The random bytes used to secure cookies.
#  See also: NotebookApp.cookie_secret
# c.LabApp.cookie_secret = b''

## The file where the cookie secret is stored.
#  See also: NotebookApp.cookie_secret_file
# c.LabApp.cookie_secret_file = ''
...
## Override URL shown to users.
#  See also: NotebookApp.custom_display_url
# c.LabApp.custom_display_url = ''
...
## Disable cross-site-request-forgery protection
#  See also: NotebookApp.disable_check_xsrf
c.LabApp.disable_check_xsrf = True

## Whether to enable MathJax for typesetting math/TeX
#  See also: NotebookApp.enable_mathjax
# c.LabApp.enable_mathjax = True
...
## extra paths to look for Javascript notebook extensions
#  See also: NotebookApp.extra_nbextensions_path
# c.LabApp.extra_nbextensions_path = []

## handlers that should be loaded at higher priority than the default services
#  See also: NotebookApp.extra_services
# c.LabApp.extra_services = []

## Extra paths to search for serving static files.
#  See also: NotebookApp.extra_static_paths
# c.LabApp.extra_static_paths = []

## Extra paths to search for serving jinja templates.
#  See also: NotebookApp.extra_template_paths
# c.LabApp.extra_template_paths = []

#  See also: NotebookApp.file_to_run
# c.LabApp.file_to_run = ''
...
## Extra keyword arguments to pass to `get_secure_cookie`. See tornado's
#  get_secure_cookie docs for details.
#  See also: NotebookApp.get_secure_cookie_kwargs
# c.LabApp.get_secure_cookie_kwargs = {}

## Deprecated: Use minified JS file or not, mainly use during dev to avoid JS
#  recompilation
#  See also: NotebookApp.ignore_minified_js
# c.LabApp.ignore_minified_js = False

## (bytes/sec)
#  See also: NotebookApp.iopub_data_rate_limit
# c.LabApp.iopub_data_rate_limit = 1000000

## (msgs/sec)
#  See also: NotebookApp.iopub_msg_rate_limit
# c.LabApp.iopub_msg_rate_limit = 1000
...
# c.LabApp.jinja_environment_options = {}

## Extra variables to supply to jinja templates when rendering.
#  See also: NotebookApp.jinja_template_vars
# c.LabApp.jinja_template_vars = {}

## The kernel manager class to use.
#  See also: NotebookApp.kernel_manager_class
# c.LabApp.kernel_manager_class = 'notebook.services.kernels.kernelmanager.MappingKernelManager'

## 
#  See also: NotebookApp.kernel_spec_manager_class
# c.LabApp.kernel_spec_manager_class = 'jupyter_client.kernelspec.KernelSpecManager'

## The full path to a private key file for usage with SSL/TLS.
#  See also: NotebookApp.keyfile
# c.LabApp.keyfile = ''

## Hostnames to allow as local when allow_remote_access is False.
#  See also: NotebookApp.local_hostnames
# c.LabApp.local_hostnames = ['localhost']
...
## The login handler class to use.
#  See also: NotebookApp.login_handler_class
# c.LabApp.login_handler_class = 'notebook.auth.login.LoginHandler'

## The logout handler class to use.
#  See also: NotebookApp.logout_handler_class
# c.LabApp.logout_handler_class = 'notebook.auth.logout.LogoutHandler'

## The MathJax.js configuration file that is to be used.
#  See also: NotebookApp.mathjax_config
# c.LabApp.mathjax_config = 'TeX-AMS-MML_HTMLorMML-full,Safe'

## A custom url for MathJax.js.
#  See also: NotebookApp.mathjax_url
# c.LabApp.mathjax_url = ''

## 
#  See also: NotebookApp.max_body_size
# c.LabApp.max_body_size = 536870912

## 
#  See also: NotebookApp.max_buffer_size
# c.LabApp.max_buffer_size = 536870912

## 
#  See also: NotebookApp.min_open_files_limit
# c.LabApp.min_open_files_limit = 0

## Dict of Python modules to load as notebook server extensions.Entry values can
#  be used to enable and disable the loading ofthe extensions. The extensions
#  will be loaded in alphabetical order.
#  See also: NotebookApp.nbserver_extensions
# c.LabApp.nbserver_extensions = {}

## The directory to use for notebooks and kernels.
#  See also: NotebookApp.notebook_dir
c.LabApp.notebook_dir = '/home'

## Whether to open in a browser after starting.
#  See also: NotebookApp.open_browser
...
## Hashed password to use for web authentication.
#  See also: NotebookApp.password
# c.LabApp.password = ''

## Forces users to use a password for the Notebook server.
#  See also: NotebookApp.password_required
# c.LabApp.password_required = False

## The port the notebook server will listen on (env: JUPYTER_PORT).
#  See also: NotebookApp.port
# c.LabApp.port = 8888

## The number of additional ports to try if the specified port is not available
#  (env: JUPYTER_PORT_RETRIES).
#  See also: NotebookApp.port_retries
# c.LabApp.port_retries = 50

## 
#  See also: NotebookApp.pylab
# c.LabApp.pylab = 'disabled'

## If True, display a button in the dashboard to quit
#  See also: NotebookApp.quit_button
# c.LabApp.quit_button = True

## (sec) Time window used to
#  See also: NotebookApp.rate_limit_window
# c.LabApp.rate_limit_window = 3

## Reraise exceptions encountered loading server extensions?
#  See also: NotebookApp.reraise_server_extension_failures
# c.LabApp.reraise_server_extension_failures = False

## DEPRECATED use the nbserver_extensions dict instead
#  See also: NotebookApp.server_extensions
# c.LabApp.server_extensions = []

## The session manager class to use.
#  See also: NotebookApp.session_manager_class
# c.LabApp.session_manager_class = 'notebook.services.sessions.sessionmanager.SessionManager'
...
#  it's not in use. This is not precisely timed: it may shut down up to a minute
#  later. 0 (the default) disables this automatic shutdown.
#  See also: NotebookApp.shutdown_no_activity_timeout
# c.LabApp.shutdown_no_activity_timeout = 0

## The UNIX socket the notebook server will listen on.
#  See also: NotebookApp.sock
# c.LabApp.sock = ''

## The permissions mode for UNIX socket creation (default: 0600).
#  See also: NotebookApp.sock_mode
# c.LabApp.sock_mode = '0600'

## Supply SSL options for the tornado HTTPServer.
#  See also: NotebookApp.ssl_options
# c.LabApp.ssl_options = {}

## Supply overrides for terminado. Currently only supports "shell_command". On
#  Unix, if "shell_command" is not provided, a non-login shell is launched by
#  default when the notebook server is connected to a terminal, a login shell
#  otherwise.
#  See also: NotebookApp.terminado_settings
# c.LabApp.terminado_settings = {}

## Set to False to disable terminals.
#  See also: NotebookApp.terminals_enabled
# c.LabApp.terminals_enabled = True

## Token used for authenticating first-time connections to the server.
#  See also: NotebookApp.token
# c.LabApp.token = '<generated>'

## Supply overrides for the tornado.web.Application that the Jupyter notebook
#  uses.
#  See also: NotebookApp.tornado_settings
c.LabApp.tornado_settings = { 'headers': { 'Content-Security-Policy': "frame-ancestors * 'self' " }}

## Whether to trust or not X-Scheme/X-Forwarded-Proto and X-Real-Ip/X-Forwarded-
#  For headerssent by the upstream reverse proxy. Necessary if the proxy handles
#  SSL
#  See also: NotebookApp.trust_xheaders
# c.LabApp.trust_xheaders = False

## Disable launching browser by redirect file
#  See also: NotebookApp.use_redirect_file
# c.LabApp.use_redirect_file = True
...
## DEPRECATED, use tornado_settings
#  See also: NotebookApp.webapp_settings
# c.LabApp.webapp_settings = {}

## Specify Where to open the notebook on startup. This is the
#  See also: NotebookApp.webbrowser_open_new
# c.LabApp.webbrowser_open_new = 2

## 
#  See also: NotebookApp.websocket_compression_options
# c.LabApp.websocket_compression_options = None

## The base URL for websockets,
#  See also: NotebookApp.websocket_url
# c.LabApp.websocket_url = ''
...
#  Choices: any of ['sha224', 'sha3_256', 'sha3_384', 'md5', 'blake2b', 'sha3_224', 'sha3_512', 'sha384', 'sha256', 'sha512', 'sha1', 'blake2s']
#  Default: 'sha256'
